...
?&gt;</code></pre>
<p>Twoim zadaniem jest w pliku zadanie1.php stworzyć nowe połączenie z bazą danych. Możesz skorzystać z powyższego kodu, modyfikując odpowiednie fragmenty.</p>